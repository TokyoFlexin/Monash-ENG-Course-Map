...
- Missing a prerequisite? The card tells you. Drop two units together that prohibit each other and it catches that too. Park something in a semester it isn't offered and you get a "not usually offered in S2" flag.
...
See [`PROGRESS.md`](PROGRESS.md) for the running status log.
